...
const DAILY_SPIN_SLOTS = [
  { type: "nothing", label: "Nothing", wheelLabel: "✗", color: "#4A4A52" },
  { type: "xpBoost", label: "1.5x XP Boost", wheelLabel: "XP", color: "#3FE8D0" },
  { type: "nothing", label: "Nothing", wheelLabel: "✗", color: "#5A5A62" },
  { type: "coins", label: "500 Coins", amount: 500, wheelLabel: "500", color: "#D4A54A" },
  { type: "nothing", label: "Nothing", wheelLabel: "✗", color: "#4A4A52" },
  { type: "xpBoost", label: "1.5x XP Boost", wheelLabel: "XP", color: "#3FE8D0" },
  { type: "nothing", label: "Nothing", wheelLabel: "✗", color: "#5A5A62" },
  { type: "coins", label: "500 Coins", amount: 500, wheelLabel: "500", color: "#D4A54A" }
...
function renderDailySpinner() {
  ...
  wheelEl.innerHTML = generateWheelSvg(DAILY_SPIN_SLOTS);
...
async function spinDailyWheel() {
  ...
  const sliceAngle = 360 / DAILY_SPIN_SLOTS.length;
