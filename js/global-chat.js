...
function renderGlobalChatMessages(messages) {
  ...
  // Consecutive-message count per sender — resets to 1 whenever the
  // sender changes, increments for each additional message they send
  // in a row without anyone else posting in between.
  let runCount = 0;
  let lastUid = null;
