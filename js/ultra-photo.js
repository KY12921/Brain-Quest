...
document.getElementById("tutor-photo-help-link").addEventListener("click", () => navigateTo("photo-help-section"));
document.getElementById("photo-help-back-btn").addEventListener("click", () => navigateTo("tutor-section"));
