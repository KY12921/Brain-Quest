...
function renderQuestion() {
  ...
  // competitive — stopping for a mini-lesson before every question
  // there would work against what those modes are for, so they skip
  ...
  if (showConceptFirst) {
    ...
    document.getElementById("concept-intro-continue-btn").onclick = () => {
