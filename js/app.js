...
const ROADMAP_MASCOT_SVG = `<svg viewBox="0 0 120 120" aria-hidden="true">
  ...
  <g filter="url(#kiwi-body-shadow)">
    ...
    <circle cx="42" cy="55" r="17" fill="url(#kiwi-eye-grad)" stroke="var(--stamp-ink)" stroke-width="2"/>
    <circle cx="78" cy="55" r="17" fill="url(#kiwi-eye-grad)" stroke="var(--stamp-ink)" stroke-width="2"/>
    <circle cx="44" cy="57" r="7" fill="url(#kiwi-pupil-grad)"/>
    <circle cx="80" cy="57" r="7" fill="url(#kiwi-pupil-grad)"/>
