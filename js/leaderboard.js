...
// hardcoded-color SVGs.
const RANK_BADGE_SVG = [
  // Bronze — simple shield
  '<svg viewBox="0 0 48 48"><path d="M24 4 L40 10 V24 C40 34 33 41 24 44 C15 41 8 34 8 24 V10 Z" fill="currentColor" opacity="0.85" stroke="currentColor" stroke-width="2"/></svg>',
  // Silver — diamond outline
  '<svg viewBox="0 0 48 48"><path d="M24 4 L42 24 L24 44 L6 24 Z" fill="none" stroke="currentColor" stroke-width="3"/></svg>',
  // Gold — filled diamond
  '<svg viewBox="0 0 48 48"><path d="M24 4 L42 24 L24 44 L6 24 Z" fill="currentColor"/><path d="M24 4 L42 24 L24 24 Z" fill="currentColor" opacity="0.6"/></svg>',
  // Platinum — faceted shield
  '<svg viewBox="0 0 48 48"><path d="M24 4 L40 12 V24 C40 34 33 41 24 44 C15 41 8 34 8 24 V12 Z" fill="currentColor" opacity="0.9"/><path d="M24 4 V44 M8 20 L40 20" stroke="#0B141C" stroke-width="1.5" opacity="0.25"/></svg>',
  // Sapphire — hexagonal gem
  '<svg viewBox="0 0 48 48"><path d="M16 6 H32 L42 24 L32 42 H16 L6 24 Z" fill="currentColor"/><path d="M16 6 L24 24 L32 6 M6 24 H42 M16 42 L24 24 L32 42" stroke="#0B141C" stroke-width="1" opacity="0.2"/></svg>',
  // Ruby — rounded gem
  '<svg viewBox="0 0 48 48"><path d="M24 6 C34 6 42 14 42 24 C42 34 34 42 24 42 C14 42 6 34 6 24 C6 14 14 6 24 6 Z" fill="currentColor"/><ellipse cx="18" cy="16" rx="5" ry="4" fill="#FFFFFF" opacity="0.3"/></svg>',
  // Emerald — elongated hex gem with facets
  '<svg viewBox="0 0 48 48"><path d="M18 4 H30 L42 16 V32 L30 44 H18 L6 32 V16 Z" fill="currentColor"/><path d="M18 4 L24 16 L30 4 M6 16 L24 16 L42 16 M6 32 L24 32 L42 32 M18 44 L24 32 L30 44" stroke="#0B141C" stroke-width="1" opacity="0.2"/></svg>',
  // Diamond — classic multi-facet diamond
  '<svg viewBox="0 0 48 48"><path d="M12 8 H36 L44 20 L24 44 L4 20 Z" fill="currentColor"/><path d="M12 8 L24 20 L36 8 M4 20 H44 M24 20 L24 44" stroke="#0B141C" stroke-width="1.2" opacity="0.25"/></svg>',
  // Master — star burst inside a diamond
  '<svg viewBox="0 0 48 48"><path d="M24 2 L30 18 L46 24 L30 30 L24 46 L18 30 L2 24 L18 18 Z" fill="currentColor"/></svg>',
  // Legend — winged crest, the most elaborate badge
  '<svg viewBox="0 0 64 48"><path d="M2 20 L16 14 L22 22 L16 26 Z" fill="currentColor" opacity="0.85"/><path d="M62 20 L48 14 L42 22 L48 26 Z" fill="currentColor" opacity="0.85"/><path d="M22 8 H42 L48 22 L32 44 L16 22 Z" fill="currentColor"/><circle cx="32" cy="22" r="6" fill="#FFFFFF" opacity="0.35"/></svg>'
];
  ...
  try {
    ...
    listEl.innerHTML = `
      <div class="rank-header">
        <span class="rank-badge-icon" style="color:${rankInfo.color}">${RANK_BADGE_SVG[displayRank]}</span>
