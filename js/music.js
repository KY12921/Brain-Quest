...
const MUSIC_TRACKS = {
  adventure: {
    name: "Adventure",
    description: "Bright, upbeat — for questing and exploring.",
    wave: "triangle",
    noteDuration: 0.3,
    notes: ["C4", "E4", "G4", "C5", "G4", "E4", "D4", "G4"]
  },
  focus: {
    name: "Focus",
    description: "Calm, ambient — for studying without distraction.",
    wave: "sine",
    noteDuration: 1.3,
    notes: ["C4", "G4", "E4", "A4"]
  },
  retro: {
    name: "Retro Quest",
    description: "Peppy 8-bit style — for boss fights and duels.",
    wave: "square",
    noteDuration: 0.15,
    notes: ["E4", "G4", "A4", "G4", "E4", "D4", "E4", "G4", "B4", "A4", "G4", "E4"]
  }
};
