...
//
// Each track uses its OWN chord pool/key and its OWN rhythmic pattern
// (steps of varying duration within a track, not just one fixed
// duration stretched or squeezed) — earlier drafts of this reused the
// same four chords (C/Am/F/G) reordered across most tracks with only
// duration changed, which is why they all sounded like the same song
// at different speeds. These are deliberately built from different
// keys/chord qualities and different rhythmic shapes instead.
const MUSIC_TRACKS = {
  lofi: {
    name: "Lo-Fi Study",
    ...
    steps: [
      ...
      { notes: ["F3", "A3", "C4"], duration: 1.2 },
      { notes: ["G3", "B3", "D4"], duration: 2.0 }
    ]
  },
  deepFocus: {
    name: "Deep Focus",
    description: "Slow, sparse dyads in a minor key — for silent, distraction-free focus.",
    wave: "sine",
    attack: 0.6,
    steps: [
      { notes: ["D4", "A4"], duration: 3.4 },
      { notes: ["G3", "D4"], duration: 3.4 },
      { notes: ["C4", "G4"], duration: 3.4 },
      { notes: ["F3", "C4"], duration: 3.4 }
    ]
  },
  rainyDay: {
    name: "Rainy Day",
    description: "Soft, reflective minor-key chords — a gentle backdrop for reading.",
    wave: "sine",
    attack: 0.15,
    steps: [
      { notes: ["E3", "G3", "B3"], duration: 2.2 },
      { notes: ["C4", "E4", "G4"], duration: 1.6 },
      { notes: ["G3", "B3", "D4"], duration: 2.2 },
      { notes: ["D4", "F4", "A4"], duration: 1.6 }
    ]
  },
  sunnyMorning: {
    name: "Sunny Morning",
    description: "Bright, upbeat progression in G major — energizing without being distracting.",
    wave: "triangle",
    attack: 0.02,
    steps: [
      { notes: ["G3", "B3", "D4"], duration: 0.8 },
      { notes: ["D4", "F4", "A4"], duration: 0.8 },
  ...
  nightOwl: {
    name: "Night Owl",
    description: "Slow, moody jazz-tinged 7th chords — for late-night sessions.",
    wave: "sine",
    attack: 0.4,
    steps: [
      { notes: ["D4", "F4", "A4", "C5"], duration: 2.6 },
      { notes: ["G3", "B3", "D4", "F4"], duration: 2.0 },
      { notes: ["C4", "E4", "G4", "B4"], duration: 2.6 },
      { notes: ["A3", "C4", "E4", "G4"], duration: 2.0 }
    ]
  },
  coffeeShop: {
    name: "Coffee Shop",
    description: "Relaxed bossa-style progression in A major — bought in the Shop.",
    wave: "triangle",
    attack: 0.05,
    shopItem: true,
    steps: [
      ...
      { notes: ["E3", "G3", "B3"], duration: 1.8 }
    ]
  },
  zenGarden: {
    name: "Zen Garden",
    description: "Slow, minimal pentatonic melody — bought in the Shop.",
    wave: "sine",
    attack: 0.8,
    shopItem: true,
    steps: [
      { notes: ["D4"], duration: 3.0 },
      { notes: ["F4"], duration: 2.2 },
      { notes: ["G4"], duration: 3.0 },
      { notes: ["A4"], duration: 2.2 },
      { notes: ["F4"], duration: 3.6 }
    ]
  }
};
