...
// quest completion, XP gained) and duels.js (duels played) — see
// registerMissionEvent() calls in each file.
// ------------------------------------------------------------------
...
const MISSIONS = [
  ...
  { id: "hintsUsed", label: "Ask Kiwi for a hint", target: 1, reward: 200, icon: NAV_ICON_SVG.tutor },
  { id: "xpEarnedToday", label: "Earn 150 XP today", target: 150, reward: 200, icon: STAR_ICON_SVG }
];

function todayString() {
  return localDateString(); // shared helper in app.js — local calendar day, not UTC
}
...
// completed quest, a duel played, XP earned). Bumps the matching
// mission's progress and auto-claims the reward the moment its
// target is reached.
