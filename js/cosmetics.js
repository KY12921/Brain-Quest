...
const DECORATION_SVG = {
  ...
  flame: '<svg viewBox="0 0 24 24" fill="#FF7A3D" stroke="#C1440E" stroke-width="0.4"><path d="M12 2c1 3-2 4-2 7a4 4 0 0 0 8 0c0-1-0.5-2-1-2.5 1.5 1 2.5 3 2.5 5a7.5 7.5 0 0 1-15 0c0-4.5 4-6 4.5-9.5 0.5 1 1 1.5 2 1.5s1.5-1 1-1.5z"/></svg>',
  leaf: '<svg viewBox="0 0 24 24" fill="#5FBF7A" stroke="#2E7D46" stroke-width="0.4"><path d="M4 20c8 0 16-6 16-16-8 0-16 6-16 16z"/><path d="M4 20c3-5 7-9 12-12" stroke="#2E7D46" stroke-width="0.6" fill="none"/></svg>'
};
