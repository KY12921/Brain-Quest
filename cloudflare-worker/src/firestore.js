...
// Firestore REST doesn't support the client SDK's `where` query the
// same way through a simple GET — this uses the runQuery endpoint,
// used specifically for finding a user by stripeCustomerId on
