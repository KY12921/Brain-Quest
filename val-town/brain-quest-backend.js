...
const GIFTABLE_ITEMS = {
  "avatar-phoenix": { cosmeticCategory: "avatarIcons", cosmeticId: "phoenix", costCoins: 700 },
  "avatar-dragon": { cosmeticCategory: "avatarIcons", cosmeticId: "dragon", costCoins: 900 },
  "avatar-wizard": { cosmeticCategory: "avatarIcons", cosmeticId: "wizard", costCoins: 750 },
  "avatar-ninja": { cosmeticCategory: "avatarIcons", cosmeticId: "ninja", costCoins: 800 },
  "avatar-phoenix-ultra": { cosmeticCategory: "avatarIcons", cosmeticId: "phoenixUltra", costCoins: 1100, requiresTier: "ultra" },
  "frame-gold": { cosmeticCategory: "frames", cosmeticId: "gold", costCoins: 600 },
  "frame-fire": { cosmeticCategory: "frames", cosmeticId: "fire", costCoins: 800 },
  "frame-ice": { cosmeticCategory: "frames", cosmeticId: "ice", costCoins: 800 },
  "frame-electric": { cosmeticCategory: "frames", cosmeticId: "electric", costCoins: 1000, requiresTier: "pro" },
  "deco-crown": { cosmeticCategory: "decorations", cosmeticId: "crown", costCoins: 700 },
  "deco-sparkle": { cosmeticCategory: "decorations", cosmeticId: "sparkle", costCoins: 500 },
  "deco-star": { cosmeticCategory: "decorations", cosmeticId: "star", costCoins: 550 },
  "deco-heart": { cosmeticCategory: "decorations", cosmeticId: "heart", costCoins: 450 },
  "nameplate-gold": { cosmeticCategory: "nameplates", cosmeticId: "gold", costCoins: 1000 },
  "nameplate-neon": { cosmeticCategory: "nameplates", cosmeticId: "neon", costCoins: 1200 },
  "nameplate-rainbow": { cosmeticCategory: "nameplates", cosmeticId: "rainbow", costCoins: 1400 },
  "nameplate-shadow": { cosmeticCategory: "nameplates", cosmeticId: "shadow", costCoins: 900 },
  "theme-sunset": { cosmeticCategory: "themes", cosmeticId: "sunset", costCoins: 1500 },
  "theme-galaxy": { cosmeticCategory: "themes", cosmeticId: "galaxy", costCoins: 1800 },
  "music-coffeeshop": { cosmeticCategory: "music", cosmeticId: "coffeeShop", costCoins: 600 },
  "music-zengarden": { cosmeticCategory: "music", cosmeticId: "zenGarden", costCoins: 700 }
};
...
async function handleCreateItemCheckoutSession(request, projectId, stripeSecretKey) {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      mode: "payment",
      line_items: [{
        price_data: { currency: "usd", product_data: { name: "Brain Quest — " + itemId }, unit_amount: coinsToCents(item.costCoins) },
        quantity: 1
      }],
      client_reference_id: auth.uid,
