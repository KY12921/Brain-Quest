...
- **The question bank grew, but isn't infinite.** It's now 243
  questions (up from ~213), with the Advanced tier of every subject
  specifically expanded and made harder — Math added limits and
  integrals, Science added kinetic energy and radioactive decay,
  History/Geography/English/CS/Economics each got 4 more genuinely
  advanced questions. Chapters still cycle through a fixed pool
  rather than generating infinite new questions — that would need a
  real AI backend.
